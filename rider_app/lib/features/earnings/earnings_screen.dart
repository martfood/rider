...
/// Redesigned Earnings / Wallet screen matching the Customer App E-Wallet UI style and design system.
          ...
          child: Responsive.maxContainer(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // ── 1. Hero Earnings Card matching Customer Wallet ──────────
                  _buildWalletHeroCard(
                    context: context,
                    fullName: profile.displayName.isNotEmpty
                        ? profile.displayName
                        : 'MartFood Rider',
                  ...
                  // ── 2. Action Buttons Row: Bank Details & History ──────────
                  Row(
                    children: [
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () => context.push('/account/bank-details'),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Flexible(
                                child: Text(
                                  bank != null ? 'Payout Details' : 'Add Bank',
                                  maxLines: 1,
                  ...
                  // ── 5. Realtime Transactions Stream ────────────────────────
          ...
          return StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, ordersSnapshot) {
                ...
                return Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Your earnings activity will appear here as soon as you complete deliveries.',
              ...
              return ListView.separated(
                shrinkWrap: true,
                physics: const NeverScrollableScrollPhysics(),
                itemCount: sortedOrders.length > 8 ? 8 : sortedOrders.length,
                separatorBuilder: (context, index) => Divider(
                  color: isDark ? AppTheme.darkBorder : const Color(0xFFEFF1F6),
                  height: 22,
                ),
