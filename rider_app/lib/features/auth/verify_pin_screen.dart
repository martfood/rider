...
/// PIN verification after password login (mock).
class VerifyPinScreen extends ConsumerStatefulWidget {
  /// Creates the verify PIN screen.
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Text(
                        'Confirm it’s you before you go online.',
                  ...
                  _VerifyKeypad(
                      isDark: isDark, onDigit: _onDigit, onDelete: _onDelete),
                  const SizedBox(height: 20),
                ],
              ),
            ),
...
class _VerifyKeypad extends StatelessWidget {
  const _VerifyKeypad({
